...
void ImGui_ImplSdlGLBinding_RenderDrawLists(ImDrawData* draw_data)
{
...
void ImGui_ImplSdlGLBinding_CreateFontsTexture()
{
    // Build texture atlas
    ImGuiIO& io = ImGui::GetIO();
...
#undef OFFSETOF
    ...
    ImGui_ImplSdlGLBinding_CreateFontsTexture();
...
bool    ImGui_ImplSdlGLBinding_Init(SDL_Window* window)
{
    ...
    io.RenderDrawListsFn = ImGui_ImplSdlGLBinding_RenderDrawLists;   // Alternatively you can set this to NULL and call ImGui::GetDrawData() after ImGui::Render() to get the same ImDrawData pointer.
