...
IMGUI_API bool ImGui_ImplSdlGlew_Init(SDL_Window *window);
IMGUI_API void ImGui_ImplSdlGlew_Shutdown();
IMGUI_API void ImGui_ImplSdlGlew_NewFrame(SDL_Window *window);
IMGUI_API bool ImGui_ImplSdlGlew_ProcessEvent(SDL_Event *event);

IMGUI_API void ImGui_ImplSdlGlew_InvalidateDeviceObjects();
IMGUI_API bool ImGui_ImplSdlGlew_CreateDeviceObjects();
